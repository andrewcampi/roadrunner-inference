...
from transformers import LlamaForCausalLM, GPT2LMHeadModel, GPT2Tokenizer, AutoTokenizer, AutoConfig, LlamaConfig
...
def run_comparison(model_name="meta-llama/Llama-3.2-1B", max_new_tokens=20):
    ...
    # Step 1: Load config.json manually
    config_path = hf_hub_download(repo_id=model_name, filename="config.json")
    with open(config_path, "r") as f:
        config_dict = json.load(f)

    # Step 2: Sanitize rope_scaling
    rope = config_dict.get("rope_scaling")
    if rope and not ("type" in rope and "factor" in rope and len(rope) == 2):
        config_dict["rope_scaling"] = {
            "type": "linear",
            "factor": rope.get("factor", 1.0)
        }

    # Step 3: Create proper LlamaConfig
    config = LlamaConfig(**config_dict)

    # Step 4: Load model
    model = LlamaForCausalLM.from_pretrained(model_name, config=config, torch_dtype=precision).to(device)
...
def execute_roadrunner_routing(model_name="meta-llama/Llama-3.2-1B", max_new_tokens=20):
...
""" Output:
🔄 Loading Llama 3 model: meta-llama/Llama-3.2-1B on cuda...
...
✅ Calibrated P0 threshold: 17.33

🔍 Running accuracy verification test...
🧪 Prompt: The meaning of life is
--- Llama 3 Baseline ---
📜 The meaning of life is to live is to live
⚡ 122.14 tokens/sec | ⏱ 8.19 ms/token
--- Routed (Matrix-Free) with Verification ---
📜 The meaning of life is to live is to live
⚡ 57.50 tokens/sec | ⏱ 17.39 ms/token
🎯 Accuracy: 100.00%

📊 Timing Breakdown:
  input_prep: 0.3% (0.23ms)
  model_forward: 50.8% (44.16ms)
  token_selection: 0.1% (0.10ms)
  memory_ops: 0.1% (0.10ms)
  verification: 48.4% (42.05ms)
------------------------------------------------------------
🧪 Prompt: In a distant galaxy, a civilization
--- Llama 3 Baseline ---
📜 In a distant galaxy, a civilization, far away galaxy,
⚡ 121.94 tokens/sec | ⏱ 8.20 ms/token
--- Routed (Matrix-Free) with Verification ---
📜 In a distant galaxy, a civilization, far away galaxy,
⚡ 58.52 tokens/sec | ⏱ 17.09 ms/token
🎯 Accuracy: 100.00%

📊 Timing Breakdown:
  input_prep: 0.3% (0.23ms)
  model_forward: 50.0% (42.71ms)
  token_selection: 0.1% (0.10ms)
  memory_ops: 0.1% (0.11ms)
  verification: 49.1% (41.99ms)
------------------------------------------------------------

⚡ Running performance test (without verification)...
🧪 Prompt: The meaning of life is
--- Llama 3 Baseline ---
📜 The meaning of life is to live is to live is to live. The life. The life. The life. The life
⚡ 118.87 tokens/sec | ⏱ 8.41 ms/token
--- Routed (Matrix-Free) Production ---
📜 The meaning of life is to live is to live is to live. The life. The life. The life. The life
⚡ 116.61 tokens/sec | ⏱ 8.58 ms/token

📊 Timing Breakdown:
  input_prep: 0.1% (0.22ms)
  model_forward: 99.2% (170.12ms)
  token_selection: 0.2% (0.38ms)
  memory_ops: 0.3% (0.46ms)
------------------------------------------------------------
🧪 Prompt: In a distant galaxy, a civilization
--- Llama 3 Baseline ---
📜 In a distant galaxy, a civilization, far away galaxy, a galaxy, a galaxy, a galaxy, a galaxy, a galaxy,
⚡ 122.43 tokens/sec | ⏱ 8.17 ms/token
--- Routed (Matrix-Free) Production ---
📜 In a distant galaxy, a civilization, far away galaxy, a galaxy, a galaxy, a galaxy, a galaxy, a galaxy,
⚡ 116.54 tokens/sec | ⏱ 8.58 ms/token

📊 Timing Breakdown:
  input_prep: 0.1% (0.26ms)
  model_forward: 99.2% (170.19ms)
  token_selection: 0.2% (0.39ms)
  memory_ops: 0.3% (0.45ms)
------------------------------------------------------------
🧪 Prompt: The future of AI will depend on
--- Llama 3 Baseline ---
📜 The future of AI will depend on the human
The future
The future of the human
The future
The future of the future
⚡ 122.12 tokens/sec | ⏱ 8.19 ms/token
--- Routed (Matrix-Free) Production ---
📜 The future of AI will depend on the human
The future
The future of the human
The future
The future of the future
⚡ 116.21 tokens/sec | ⏱ 8.60 ms/token

📊 Timing Breakdown:
  input_prep: 0.1% (0.22ms)
  model_forward: 99.2% (170.72ms)
  token_selection: 0.2% (0.38ms)
  memory_ops: 0.3% (0.44ms)
------------------------------------------------------------
🧪 Prompt: Once upon a time
--- Llama 3 Baseline ---
📜 Once upon a time, there was a time, there was a long ago, a time, a long ago, a
⚡ 122.24 tokens/sec | ⏱ 8.18 ms/token
--- Routed (Matrix-Free) Production ---
📜 Once upon a time, there was a time, there was a long ago, a time, a long ago, a
⚡ 116.82 tokens/sec | ⏱ 8.56 ms/token

📊 Timing Breakdown:
  input_prep: 0.1% (0.22ms)
  model_forward: 99.2% (169.81ms)
  token_selection: 0.2% (0.38ms)
  memory_ops: 0.3% (0.45ms)
------------------------------------------------------------
🧪 Prompt: The quantum computer
--- Llama 3 Baseline ---
📜 The quantum computer is a device that is a computer is a computer is a computer that is a computer
The computer
⚡ 122.19 tokens/sec | ⏱ 8.18 ms/token
--- Routed (Matrix-Free) Production ---
📜 The quantum computer is a device that is a computer is a computer is a computer that is a computer
The computer
⚡ 116.40 tokens/sec | ⏱ 8.59 ms/token

📊 Timing Breakdown:
  input_prep: 0.1% (0.23ms)
  model_forward: 99.1% (170.34ms)
  token_selection: 0.2% (0.38ms)
  memory_ops: 0.3% (0.52ms)
------------------------------------------------------------

📊 Overall Summary:
Prompt | Baseline (tok/s) | Matrix-Free (tok/s) | Speedup | Accuracy
--------------------------------------------------------------------------------
The meaning of life ... | 118.87 | 116.61 | 0.98x | Verified
In a distant galaxy,... | 122.43 | 116.54 | 0.95x | Verified
The future of AI wil... | 122.12 | 116.21 | 0.95x | Verified
Once upon a time | 122.24 | 116.82 | 0.96x | Verified
The quantum computer | 122.19 | 116.4 | 0.95x | Verified
--------------------------------------------------------------------------------
AVERAGE | | | 0.96x | Verified

⚠️ No speedup achieved. Current overhead: 4.3%
"""