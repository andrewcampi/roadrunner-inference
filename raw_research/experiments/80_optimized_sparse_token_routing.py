...
⚡ 61.45 tokens/sec | ⏱ 16.27 ms/token
--- Routed (Matrix-Free) with Verification ---
📜 The meaning of life is to find your passion and
⚡ 8.84 tokens/sec | ⏱ 113.08 ms/token
🎯 Accuracy: 100.00%

📊 Timing Breakdown:
  input_prep: 0.2% (1.08ms)
  model_forward: 51.1% (288.75ms)
  token_selection: 0.1% (0.30ms)
  memory_ops: 0.0% (0.00ms)
  verification: 47.9% (271.05ms)
------------------------------------------------------------
🧪 Prompt: In a distant galaxy, a civilization
--- Llama 3 Baseline ---
📜 In a distant galaxy, a civilization has developed a technology that
⚡ 62.04 tokens/sec | ⏱ 16.12 ms/token
--- Routed (Matrix-Free) with Verification ---
📜 In a distant galaxy, a civilization has developed a technology that
⚡ 8.67 tokens/sec | ⏱ 115.28 ms/token
🎯 Accuracy: 100.00%

📊 Timing Breakdown:
  input_prep: 0.1% (0.46ms)
  model_forward: 50.5% (290.94ms)
  token_selection: 0.0% (0.28ms)
  memory_ops: 0.0% (0.00ms)
  verification: 48.7% (280.66ms)
------------------------------------------------------------
...
⚡ 24.74 tokens/sec | ⏱ 40.42 ms/token
...
⚡ 24.70 tokens/sec | ⏱ 40.49 ms/token
--- Routed (Matrix-Free) Production ---
📜 In a distant galaxy, a civilization has developed a technology that allows them to travel through space and time. They have discovered a way to
⚡ 16.99 tokens/sec | ⏱ 58.85 ms/token

📊 Timing Breakdown:
  input_prep: 0.0% (0.38ms)
  model_forward: 97.0% (1141.91ms)
...
The future of AI will depend on how we use it
The future of
⚡ 24.65 tokens/sec | ⏱ 40.57 ms/token
--- Routed (Matrix-Free) Production ---
📜 The future of AI will depend on how we use it
The future of AI will depend on how we use it
The future of
⚡ 16.80 tokens/sec | ⏱ 59.51 ms/token

📊 Timing Breakdown:
  input_prep: 0.0% (0.41ms)
  model_forward: 97.1% (1155.63ms)
...
⚡ 24.87 tokens/sec | ⏱ 40.22 ms/token
--- Routed (Matrix-Free) Production ---
📜 Once upon a time, there was a man who was very rich. He had a lot of money, and he was
⚡ 17.03 tokens/sec | ⏱ 58.73 ms/token

📊 Timing Breakdown:
  input_prep: 0.0% (0.39ms)
  model_forward: 97.2% (1141.19ms)
...
⚡ 24.93 tokens/sec | ⏱ 40.11 ms/token
--- Routed (Matrix-Free) Production ---
📜 The quantum computer is a computer that uses quantum mechanics to perform calculations. It is a new type of computer that uses
⚡ 17.05 tokens/sec | ⏱ 58.66 ms/token

📊 Timing Breakdown:
  input_prep: 0.0% (0.40ms)
  model_forward: 97.2% (1140.08ms)
...
--------------------------------------------------------------------------------
The meaning of life ... | 24.74 | 17.18 | 0.69x | Verified
In a distant galaxy,... | 24.7 | 16.99 | 0.69x | Verified
The future of AI wil... | 24.65 | 16.8 | 0.68x | Verified
Once upon a time | 24.87 | 17.03 | 0.68x | Verified
The quantum computer | 24.93 | 17.05 | 0.68x | Verified
--------------------------------------------------------------------------------
AVERAGE | | | 0.69x | Verified

⚠️ No speedup achieved. Current overhead: 45.7%
"""